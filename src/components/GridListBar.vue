...
<template>
    ...
    <ul v-if="layout == 'grid'" class="grid">
        ...
        <li v-for="employee in employees">
            <a v-bind:href="employee.avatar" target="_blank"><img src="/default-avatar.jpg" /></a>
        </li>
    </ul>
    ...
    <ul v-if="layout == 'list'" class="list">
        ...
        <li v-for="employee in employees">
            <a v-bind:href="employee.avatar" target="_blank"><img v-bind:src="employee.avatar" /></a>
